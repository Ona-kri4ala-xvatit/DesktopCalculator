        ...
        private void EqualOperation(object? sender, EventArgs e)
        {
            ...
            switch (operation)
            {
                ...
                case "/":
                    try
                    {
                        if (resultRichTextBox.Text == "0") //число типа double при делении на ноль возращает бесконечность, а не выкидывает исключение. Поэтому приходится просто проверять второе число на ноль   
                        {
